...
function lineNeedsSemicolon(raw) {
...
export function validateJava(code, monaco) {
  const lines = code.split('\n')
  const markers = []

  let inBlockComment = false
  const braceStack  = []  // track { positions
  const parenStack  = []  // track ( positions
...
export function attachValidator(editor, monaco) {
