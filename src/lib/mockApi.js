 ...
 *    fallback branches in executeApi.js and submissionApi.js. Nothing else
 *    imports this file.
 *
...
export const EXECUTE_SCENARIOS = [
  {
...
const PIN_EXECUTE = null // e.g. 2 to always return the compile-error scenario
const PIN_SUBMIT = null
