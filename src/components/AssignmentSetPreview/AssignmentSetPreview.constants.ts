...
export const PREVIEW_TITLE_CLASS = 'text-[15px] font-bold text-foreground'
...
export const PREVIEW_ITEM_CLASS = 'group rounded-md border border-border bg-card'
...
export const PREVIEW_CARET_CLASS =
  'shrink-0 text-[10px] text-muted-foreground transition-transform group-open:rotate-90'

export const PREVIEW_TITLE_ROW_CLASS = 'min-w-0 flex-1 truncate text-[13px] text-foreground'

export const PREVIEW_KIND_CLASS =
  'shrink-0 rounded border border-border px-1.5 py-[1px] text-[10px] uppercase tracking-[0.5px] text-muted-foreground'

export const PREVIEW_DETAIL_CLASS =
  'flex flex-col gap-2 border-t border-border px-3 py-2.5'

export const PREVIEW_DESC_CLASS = 'text-[12px] leading-relaxed text-muted-foreground'
