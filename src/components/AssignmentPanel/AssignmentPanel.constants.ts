...
export const PANEL_TITLE_CLASS = 'mb-3 text-[17px] font-semibold tracking-tight text-foreground'

export const PANEL_LESSON_TEXT_CLASS = 'mb-3 whitespace-pre-wrap text-[13px] leading-relaxed text-muted-foreground'
...
export const PANEL_TASK_LABEL_CLASS = 'mb-1.5 mt-4 text-[11px] font-semibold uppercase tracking-[0.8px] text-accent'

export const PANEL_TASK_CLASS = 'whitespace-pre-wrap text-[13px] leading-relaxed text-foreground'

export const PANEL_BODY_CLASS = 'mt-3 whitespace-pre-wrap text-[13px] leading-relaxed text-muted-foreground'
