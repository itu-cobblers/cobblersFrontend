...
export const ROSTER_SUBHEADER_CLASS =
  'border-b border-divider bg-wash-subtle px-3 py-1.5 text-[13px] font-medium text-foreground truncate'
...
export const ROSTER_ITEM_ACTIVE_CLASS = 'bg-wash-active text-foreground'

export const ROSTER_ITEM_IDLE_CLASS = 'text-muted-foreground hover:bg-wash-hover hover:text-foreground'
