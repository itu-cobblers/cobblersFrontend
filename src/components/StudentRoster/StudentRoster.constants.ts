...
export const ROSTER_EMPTY_CLASS = 'text-[12px] leading-relaxed text-muted-foreground'
...
export const ROSTER_NAME_CLASS = 'text-[14px] font-semibold text-foreground'

export const ROSTER_META_CLASS = 'flex items-center justify-between gap-2 text-[12px] text-muted-foreground'
...
export const ROSTER_PILL_TONE_CLASS: Record<RosterStatus, string> = {
  ...
  stuck: 'bg-status-error/15 text-status-error',
