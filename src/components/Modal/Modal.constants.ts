...
export const MODAL_OVERLAY_CLASS =
  'fixed inset-0 z-[100] flex items-center justify-center bg-foreground/35 p-5 backdrop-blur-[2px]'

const MODAL_DIALOG_BASE_CLASS =
  'w-full rounded-[10px] border border-border bg-card p-[22px] pb-[18px]'
