...
export const FILE_TAB_BASE_CLASS =
  'relative flex h-full items-center gap-1.5 px-3 font-mono text-[13px] transition-colors'
...
export const FILE_TAB_READ_ONLY_LABEL_CLASS = 'flex items-center gap-2.5 text-sm font-medium mr-2 text-xs font-medium text-foreground'