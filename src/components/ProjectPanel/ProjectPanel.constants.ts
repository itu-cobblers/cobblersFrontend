...
// chrome as OutputPanel (bg-terminal-raised, terminal-line borders) so swapping
...
export const PROJECT_PANEL_CLASS = 'flex h-[40%] shrink-0 flex-col border-t border-divider bg-terminal-raised font-mono'
