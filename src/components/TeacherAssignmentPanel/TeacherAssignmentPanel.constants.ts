...
export const FILTER_PILL_CLEAR_CLASS = 'hover:text-accent focus:outline-none'

export const TAB_SUBMISSIONS_COUNT_CLASS = 'ml-1.5 rounded-full bg-muted px-1.5 py-0.2 text-[10px] font-mono'

export const FOCUS_BUTTON_BASE_CLASS =
  'inline-flex shrink-0 items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-semibold transition-colors'
export const FOCUS_BUTTON_ACTIVE_CLASS = 'bg-accent/20 text-accent border border-accent/40'
export const FOCUS_BUTTON_IDLE_CLASS = 'bg-accent text-accent-foreground hover:brightness-110'

export const SUBMISSIONS_EMPTY_TITLE_CLASS = 'mt-3 text-sm font-medium'
