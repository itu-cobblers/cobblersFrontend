...
export const STUDENT_WORKSPACE_MAIN_CLASS = 'relative z-10 flex flex-1 overflow-hidden'
...
export const STUDENT_WORKSPACE_EDITOR_COLUMN_CLASS = 'flex min-w-0 flex-[6] flex-col overflow-hidden'
