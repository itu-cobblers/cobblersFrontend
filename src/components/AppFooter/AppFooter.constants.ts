...
export const APP_FOOTER_ADDRESS_CLASS = 'min-w-0 truncate text-[12px] text-background/80'

export const APP_FOOTER_BRAND_CLASS =
  'flex h-7 shrink-0 items-center bg-foreground px-3 text-[12px] uppercase tracking-[0.02em] text-background'
