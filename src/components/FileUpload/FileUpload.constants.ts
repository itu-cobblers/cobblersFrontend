...
export const DROPZONE_IDLE_CLASS = 'border-terminal-line bg-wash-panel hover:border-terminal-muted hover:bg-wash-strong'
...
export const FILE_CHIP_CLASS =
  'rounded bg-wash-strong px-2 py-0.5 font-mono text-[11px] text-terminal-ink'
