...
export const ENTRY_PORTAL_BRAND_CLASS =
  'inline-flex items-center gap-2 rounded-full border border-border bg-black/[0.03] px-4 py-1.5 text-[11px] uppercase tracking-[0.3em] text-foreground/60'

export const ENTRY_PORTAL_DOT_CLASS = 'h-1.5 w-1.5 rounded-full bg-accent'
...
export const ENTRY_PORTAL_NAME_INPUT_CLASS =
  '[field-sizing:content] min-w-[1ch] max-w-full border-none bg-transparent text-center text-3xl font-light tracking-[0.02em] text-foreground outline-none sm:text-4xl'
